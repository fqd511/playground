...
var intervalInMin = 60 * 6 + 1; // base interval: 6 hours
...
var lastClickTimeStamp = new Date('2024/4/6 14:26').getTime()
...
function execute() {
	...
	if (timeLeft > 1000) {
		console.log(new Date().toLocaleString(), "距离" + new Date(lastClickTimeStamp + timeGap).toLocaleString() + "剩余：" + ((timeLeft) / oneMinute).toFixed(2) + "分");
	} else {
